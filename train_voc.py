...
def get_args():
    ...
    parser.add_argument("--pre_trained_model_type", type=str, choices=["model", "params","scratch"], default="scratch")
    parser.add_argument("--pre_trained_model_path", type=str, default="trained_models")
