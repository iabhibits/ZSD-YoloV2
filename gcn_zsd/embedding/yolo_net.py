...
class Yolo(nn.Module):
    def __init__(self, num_classes,
        ...
        self.stage3_conv1 = nn.Sequential(nn.Conv2d(256 + 1024, 1024, 3, 1, 1, bias=False), nn.BatchNorm2d(1024),
                                          nn.LeakyReLU(0.1, inplace=True))
        self.stage3_conv2 = nn.Conv2d(1024, 1024, 1, 1, 0, bias=False)
        self.stage3_conv3 = nn.Conv2d(1024, 1024, 1, 1, 0, bias=False)
    ...
    def forward(self, input):
        ...
        emb_class_output = self.stage3_conv2(output)
        emb_reg_output = self.stage3_conv3(output)
        class_output = self.stage4_conv2(emb_class_output)
        bb_output = self.stage4_conv1(emb_reg_output)
